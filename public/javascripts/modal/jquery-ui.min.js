...
(function(c,j){c.widget("ui.dialog",{options:{autoOpen:true,buttons:{},closeOnEscape:false,closeText:"",dialogClass:"",draggable:false,hide:null,height:"auto",maxHeight:false,maxWidth:false,minHeight:150,minWidth:800,modal:false,position:{my:"center",at:"center",of:window,collision:"",using:function(a){var b=c(this).css(a).offset().top;b<0&&c(this).css("top",a.top-b)}},resizable:true,show:null,stack:true,title:"",width:300,zIndex:1E3},_create:function(){this.originalTitle=this.element.attr("title");
