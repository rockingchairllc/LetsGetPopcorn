...
before_filter :authenticate_user!, :except => [:movies, :matches, :show, :contact, :imdb, :watchlist, :showtime, :search]
  ...
  def contact
    ...
    def watchlist
      ...
      url3 = "http://api.tmsdatadirect.com/movies/TheatresAndShowtimesByMovie?rType=xml&srvcVersion=1.0&aid=rocking-4q7&key=K4w3s3D93NFg&movieId=#{params[:id]}&postalCode=10098&country=USA&date=#{current_date}&numDays=7&numTheatres=&radius=100&radiusUnit=mi"
